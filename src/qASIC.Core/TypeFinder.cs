...
public static class TypeFinder
{
    ...
    public static IEnumerable<Type> FindClassesWithAttribute<T>()
        where T : Attribute =>
        FindClassesWithAttribute(typeof(T));

    public static IEnumerable<Type> FindClassesWithAttribute(Type type) =>
    ...
    public static IEnumerable<T> CreateConstructorsFromTypes<T>(IEnumerable<Type> types) =>
        types.SelectMany(x =>
        {
            ...
            if (constructor == null || constructor.IsAbstract) return Array.Empty<T>();
