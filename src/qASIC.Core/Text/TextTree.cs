...
public class TextTree(string middleItemBranch, string lastItemBranch, string space, string verticalBranch)
{
    ...
    public string Middle { get; set; } = middleItemBranch;
    /// <summary>Prefix for the last item in a list.</summary>
    public string Last { get; set; } = lastItemBranch;
    ...
    public string Vertical { get; set; } = verticalBranch;
