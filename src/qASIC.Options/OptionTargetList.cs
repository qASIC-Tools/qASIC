...
public class OptionTargetList : IEnumerable<KeyValuePair<string, OptionTargetList.Target>>, IService
{
    ...
    public OptionsManager Manager
    {
        ...
        set
        {
            field?.OnOptionChanged.mainAction -= Manager_OnOptionChanged;
            field = value;
            field?.OnOptionChanged.mainAction += Manager_OnOptionChanged;
        }
    }
    ...
    public class MethodTarget(MethodInfo method) : Target
    {
        public MethodInfo Method { get; } = method;

        private readonly ParameterInfo[] parameters = method.GetParameters();
        ...
        public override void SetValue(object obj, ChangeOptionArgs args)
        {
            switch (parameters.Length)
            {
                case 0:
                    ...
                    break;
                case 1:
                    Method.Invoke(obj, [ parameters[0].ParameterType == typeof(ChangeOptionArgs) ?
                        args :
                        args.value ]);
                    break;
                case 2:
    ...
    public class PropertyTarget(PropertyInfo property) : Target
    {
    ...
    public class FieldTarget(FieldInfo field) : Target
    {
