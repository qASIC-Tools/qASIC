...
public class ChangeOption(OptionsManager manager) : OptionsCommand(manager)
{
    public override string CommandName => "changeoption";
    public override string[] Aliases => ["setoption", "changesetting", "setsetting"];
    ...
    private object GetValueFromArg(qCommandArgument arg, Type type)
    {
        if (type != null)
    ...
    private object AskForValue(qLogManager logs, Data data)
    {
