...
public class qConsole : IService
{
    ...
    public qInstance Instance
    {
        ...
        set
        {
            ...
            Targets.StopSyncingWithOther(field?.RegisteredObjects);
            field = value;
            Targets.SyncWithOther(field?.RegisteredObjects);
    ...
    public qRegisteredObjects Targets { get; } = new qRegisteredObjects();
    #endregion
    ...
    {
        if (context.previousValue is not CommandPrompt)
    ...
    public async Task<object> ExecuteCodeAsync(string commandName, Task task, qLogManager logs = null, bool logOutput = true)
    {
        try
        {
            if (task is not Task<object> objTask)
            {
                await task;
                return null;
            }
    ...
    public bool GetLogsFromInstance
    {
        ...
        set
        {
            ...
            {
                case true:
                    Logs.Register(Instance);
                    break;
                case false:
                    Logs.Unregister(Instance);
                    break;
            }
        }
    }
